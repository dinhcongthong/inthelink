    ...
    <div class="content-wrapper">
        <div class="content-header row mb-1">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block border-0">Parent Category</h3>
            </div>
                        ...
                        <div class="page-content">
                            <div class="page-table--wrap">
                                ...
                                <div class="table-responsive">
                                    <table id="table_category" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle w-100">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Name</th>
