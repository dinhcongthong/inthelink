...
@section('content')
<div class="common-wrap ecommerce__category-last">
    ...
    <div class="page-content tab-content">
        <div class="page-table--wrap tab-pane  active" id="sub">
            ...
            <div class="page-table table-responsive">
                <table id="table_category_last" class="table dataTable-wrap w-100">    
                    <thead>
                        <tr>
                            <th class="no-sort">#</th>
                            <th>ID</th>
                            ...
                            <th>
                                Subcat
                                <i class="fas fa-question-circle main-blue" data-toggle="tooltip" title="If a category has subcategories, the value in brackets shows the overall number of products in both that category and all its subcategories."></i>
                            </th>
                            <th>Products</th>
                            <th>Is Show</th>
                            <th>Update At</th>
