                            ...
                            <div class="d-flex flex-wrap profile__wrap-body row">
                                <form class="form form-horizontal row-separator needs-validation w-100" novalidate=""
                                    ...
                                    <div class="form-body">
                                        ...
                                        <h4 class="form-section"><i class="ft ft-credit-card"></i>Identify Card</h4>

                                        <div class="form-group row mx-auto last">
                                            <label class="col-md-3 label-control" for="projectinput6">ID's Front</label>
                                            <div class="col-md-9">
                                                <div class="box has-advanced-upload" method="post" action=""
                                                    enctype="multipart/form-data">
                                                    <div class="box__input">
                                                        <img src="{{ optional($influencer->getIdentityFontThumb()->first())->url ?? asset('images/overview/no-image-6x4.png') }}"
                                                            alt="card" class="m-auto mw-100" width="300">
                                                        <input class="box__file" type="file"
                                                            name="identity_font_thumb[]" id="myImg-front"
                                                        ...
                                                        <label for="myImg-front" class="upload-btn btn "
                                                            style="cursor: pointer">Upload</label>
                                                    </div>
                                                    <div class="box__uploading">Uploading&hellip;</div>
                                                    <div class="box__success">Done!</div>
                                        ...
                                        <div class="form-group row mx-auto last">
                                            <label class="col-md-3 label-control" for="projectinput6">ID's Back</label>
                                            <div class="col-md-9">
                                                @if ($errors->any())
                                                ...
                                                <div class="box has-advanced-upload" method="post" action=""
                                                    enctype="multipart/form-data">
                                                    <div class="box__input">
                                                        <img src="{{ optional($influencer->getIdentityBackThumb()->first())->url ?? asset('images/overview/no-image-6x4.png') }}"
                                                            alt="card" width="300" class="m-auto mw-100">
                                                        <input class="box__file" type="file"
                                                            name="identity_back_thumb[]" id="myImg-back"
                                                            data-multiple-caption="{count} files selected" multiple />
                                                        <label
                                                            class="box__dragndrop box__button justify-content-center">
                                                            Limit data 6MB
                                                        ...
                                                        <label for="myImg-back" class="upload-btn btn"
                                                            style="cursor: pointer">Upload</label>
                                                    </div>
                                                    <div class="box__uploading">Uploading&hellip;</div>
                                                    <div class="box__success">Done!</div>
                                        ...
                                        <h4 class="form-section"><i class="ft ft-credit-card"></i>Bank Account</h4>
                                        <div class="form-group row mx-auto">
                                            <label for="" class="col-md-3 label-control">Bank Name</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Bank name"
                                                    name="bank_name" value="{{ $influencer->bank_name }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mx-auto">
                                            <label class="col-md-3 label-control" for="projectinput6">Bank account
                                                number</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="ID number"
                                                    name="bank_acc_num" value="{{ $influencer->bank_acc_num }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="form-group row mx-auto">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="ID number"
                                                    name="bank_acc_name" value="{{ $influencer->bank_acc_name }}"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
